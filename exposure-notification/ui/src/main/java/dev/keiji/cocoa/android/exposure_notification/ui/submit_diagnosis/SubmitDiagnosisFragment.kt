...
@AndroidEntryPoint
class SubmitDiagnosisFragment : Fragment(R.layout.fragment_diagnosis_submission) {
    companion object {
        fun newInstance(): SubmitDiagnosisFragment {
            val fragment = SubmitDiagnosisFragment()
    ...
    private val viewModel: SubmitDiagnosisViewModel by viewModels()
    ...
    private val defaultViewModel: SubmitDiagnosisViewModel
        get() = viewModel

    @Composable
    fun Submission(
        viewModel: SubmitDiagnosisViewModel = defaultViewModel,
        onSubmit: () -> Unit = {}
    ) {
        MdcTheme {
            Column(
